...
# MAGIC %md
# MAGIC # Alteryx Workflow Parser
# MAGIC Parses Alteryx `.yxmd` workflow XML into structured models (Containers, Tools, Connections).
# MAGIC Handles nested containers, all tool types, and connection tracking.
# MAGIC
# MAGIC **Usage:** This notebook is imported by other notebooks via `%run ./parser`
# MAGIC
...
logger = logging.getLogger("alteryx_converter.parser")
